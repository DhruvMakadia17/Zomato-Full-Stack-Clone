    ...
    return ( <>
        ...
        <div className = "flex w-3/4 bg-white shadow-md px-3 py-3 flex items-center gap-3 border border-gray-200 rounded">
            <div className= "flex items-center gap-2 border-r-2 border-gray-300 pr-2">
                ...
                <input type="text" placeholder="Motikhavdi, Jamnagar" className = "focus:outline-none" />
                <IoMdArrowDropdown/>
            </div>
...
const LargeNav = () => {
    return( <> 
        ...
        <div className = "flex w-full bg-white shadow-md px-3 py-3 flex items-center gap-3 border border-gray-200 rounded">
            <div className= "flex items-center gap-2 border-r-2 border-gray-300 pr-2">
                <span className= "text-zomato-400">
                    <HiLocationMarker />
                </span>
                <input type="text" placeholder="Motikhavdi, Jamnagar" />
                <IoMdArrowDropdown/>
            </div>
